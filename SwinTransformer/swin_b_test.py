...
model_path = '/home/dnnlab/muhammed/SwinTransformer/saved_model/swin_b_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = models.swin_b(weights='DEFAULT', progress=True)
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (SwinTransformer_Base)")    
