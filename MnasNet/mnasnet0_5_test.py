...
model_path = '/home/dnnlab/muhammed/MnasNet/saved_model/MnasNet0_5_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = torch.hub.load('pytorch/vision:v0.13.0', 'mnasnet0_5', pretrained=True)
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (MnasNet0_5)")    
