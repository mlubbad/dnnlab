...
model_path = '/home/dnnlab/muhammed/Densenet/saved_model/Densenet_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (DenseNet-121)")    
