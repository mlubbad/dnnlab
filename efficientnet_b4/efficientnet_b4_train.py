...
#model = AlexNet.from_pretrained('alexnet', num_classes=len(class_names))
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/EFFICIENTNET_b4_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/EFFICIENTNET_b4_best_model.pt')
