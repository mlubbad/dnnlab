...
model_path = '/home/dnnlab/muhammed/Squeezenet/saved_model/SqueezeNet_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (SqueezeNet)")    
