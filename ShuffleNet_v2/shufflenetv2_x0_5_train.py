...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/ShuffleNetV2_x0_5_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/ShuffleNetV2_x0_5_best_model.pt')
