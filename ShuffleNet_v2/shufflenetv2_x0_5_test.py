...
model_path = '/home/dnnlab/muhammed/ShuffleNet_v2/saved_model/ShuffleNetV2_x0_5_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (ShuffleNet_v2_x0_5)")    
