...
print(num_features)
model.AuxLogits.fc = nn.Linear(768, len(class_names))
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/inception_v3_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/inception_v3_best_model.pt')
