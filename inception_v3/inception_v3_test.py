...
data_dir = '/home/server/muhammed/dnnlab/inception_v3/test'
model_path = '/home/server/muhammed/dnnlab/inception_v3/saved_model/inception_v3_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (VGG19)")    
