...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/RESNET34_v2-best.pt'))
    print("Loaded!")
...
model = train_model(vgg16, criterion, optimizer_ft, exp_lr_scheduler, num_epochs=num_epochs)
torch.save(model.state_dict(), f'{saved_model_dir}/RESNET34_v2-best.pt')
