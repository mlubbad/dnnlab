...
model_path = '/home/dnnlab/muhammed/WideResNet/saved_model/wide_resnet50_2_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = torch.hub.load('pytorch/vision:v0.13.0', 'wide_resnet50_2', pretrained=True)
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (wide_resnet50_2)")    
