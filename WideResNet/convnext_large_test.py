...
model_path = '/home/dnnlab/muhammed/ConvNext/saved_model/convnext_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = torch.hub.load('pytorch/vision:v0.13.0', 'convnext_large', pretrained=True)
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (ConvNext_Large)")    
