...
model_path = '/home/dnnlab/muhammed/VisionTransformer/saved_model/vit_l_32_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = models.vit_l_32(weights='DEFAULT', progress=True)
...
model.heads[0] = nn.Linear(1024, len(class_names))
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (VisionTransformers[vit_l_32])")    
