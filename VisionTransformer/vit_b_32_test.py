...
model_path = '/home/dnnlab/muhammed/VisionTransformer/saved_model/vit_b_32_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = models.vit_b_32(weights='DEFAULT', progress=True)
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (VisionTransformers[vit_b_32])")    
