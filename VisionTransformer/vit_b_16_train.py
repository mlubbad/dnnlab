...
#model = torch.hub.load('pytorch/vision:v0.13.0', 'vit_b_16', pretrained=True)
model = models.vit_b_16(weights= 'DEFAULT', progress=True)
print(model)
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/vit_b_16_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/vit_b_16_best_model.pt')
