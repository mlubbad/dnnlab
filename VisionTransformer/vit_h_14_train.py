...
#model = torch.hub.load('pytorch/vision:v0.13.0', 'vit_h_14', pretrained=True)
model = models.vit_h_14(weights= 'DEFAULT', progress=True)
print(model)
...
model.heads[0] = nn.Linear(1280, len(class_names))
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/vit_h_14_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/vit_h_14_best_model.pt')
