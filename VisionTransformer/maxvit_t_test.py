...
data_dir = '/home/dnnlab3/Desktop/IMPLANT-2022/data-aug'
model_path = '/home/dnnlab3/Desktop/IMPLANT-2022/dnnlab/VisionTransformer/saved_model/maxvit_t_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = models.maxvit_t(weights='DEFAULT', progress=True)
#model = torch.hub.load('pytorch/vision:v0.13.0', 'resnext101', pretrained=True)
...
model.classifier[5] = nn.Conv2d(512, num_classes, kernel_size=(1,1), stride=(1,1))
...
#model.heads[0] = nn.Linear(768, len(class_names))
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (VisionTransformers[maxvit_t])")    
