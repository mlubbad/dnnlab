...
model = torch.hub.load('pytorch/vision:v0.13.0', 'regnet_y_8gf', pretrained=True)
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/regnet_y_8gf_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/regnet_y_8gf_best_model_trial_5-aug.pt')
