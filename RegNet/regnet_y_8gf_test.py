...
model_path = '/home/dnnlab3/Desktop/IMPLANT-2022/dnnlab/RegNet/saved_model/regnet_y_8gf_best_model_trial_5-aug.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = torch.hub.load('pytorch/vision:v0.13.0', 'regnet_y_8gf')
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (regnet_y_8gf)")    
