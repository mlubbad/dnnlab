...
model_path = '/home/dnnlab/muhammed/RegNet/saved_model/regnet_y_16gf_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
print('-' * 10)
model = torch.hub.load('pytorch/vision:v0.11.0', 'regnet_y_16gf')
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (regnet_y_16gf)")    
