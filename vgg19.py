...
if resume_training:
    ...
    model_ft.load_state_dict(torch.load(f'{saved_model_dir}/VGG19_v2-OCT_Retina_half_dataset.pt'))
    print("Loaded!")
...
torch.save(model_ft.state_dict(), f'{saved_model_dir}/VGG19_v2-OCT_Retina_complete_dataset.pt')
