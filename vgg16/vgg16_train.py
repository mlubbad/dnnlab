...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/VGG16_best_model_trial_1.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/VGG16_best_model_trail_1.pt')
