...
model_path = '/home/dnnlab/muhammed/vgg16/saved_model/VGG16_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (VGG16) After Dyna Class Augmentation")    
