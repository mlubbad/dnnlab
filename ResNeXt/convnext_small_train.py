...
model = torch.hub.load('pytorch/vision:v0.13.0', 'convnext_small', pretrained=True)
...
#model.classifier[-1] = nn.Linear(768, len(class_names))
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/convnext_small_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/convnext_small_best_model.pt')
