...
model = torch.hub.load('pytorch/vision:v0.13.0', 'convnext_base', pretrained=True)
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/convnext_base_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/convnext_base_best_model.pt')
