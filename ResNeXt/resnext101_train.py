...
#model = torch.hub.load('pytorch/vision:v0.13.0', 'resnext101_64x4d', pretrained=True)
...
if resume_training:
    ...
    model.load_state_dict(torch.load(f'{saved_model_dir}/resnext101_best_model.pt'))
    print("Loaded!")
...
torch.save(model.state_dict(), f'{saved_model_dir}/resnext101_best_model.pt')
