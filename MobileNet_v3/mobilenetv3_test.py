...
model_path = '/home/dnnlab/muhammed/MobileNet_v3/saved_model/MobileNetV3_best_model.pt'
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (MobileNet-V3)")    
