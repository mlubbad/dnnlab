...
model_path = "/home/dnnlab/muhammed/%s/saved_model/RESNET50_best_model.pt" % (model_name)
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size =16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (RESNET50)")    
