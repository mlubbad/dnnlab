...
saved_model_dir = "/home/dnnlab/muhammed/%s/saved_model/ALEXNET_best_model.pt" % (model_name)
model_path = "/home/dnnlab/muhammed/%s/saved_model/ALEXNET_best_model.pt" % (model_name)
TRAIN = 'test'
VAL = 'test'
TEST = 'test'
batch_size = 16
...
plot_heatmap(y_true, y_preds, class_names, ax1, title="Transfer Learning (ALEXNET)")    
